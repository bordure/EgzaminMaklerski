    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Egzamin Maklerski</h1>
          <p className="text-gray-600">Sign in to access Egzamin Maklerski simulator</p>
        </div>
        ...
        <div className="mt-6 text-center">
          <p className="text-xs text-gray-500">
            By signing in, you agree to access exam questions and track your progress securely.
          </p>
        </div>
      </div>
    </div>
