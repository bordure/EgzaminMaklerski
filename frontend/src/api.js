...
export const adminTriggerImport = (drop = true) =>
  api.post("/admin/import", null, { params: { drop }, timeout: 310_000 }).then((r) => r.data);
export const submitAnswer = (payload) =>
  api.post("/user/answer", payload).then((r) => r.data);
